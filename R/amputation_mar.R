...
# this piece of code comes from the R-miss-tastic website:
# https://raw.githubusercontent.com/R-miss-tastic/website/master/static/how-to/generate/amputation.R
